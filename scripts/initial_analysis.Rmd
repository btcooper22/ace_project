...
So here, to goal is to 'replicate' Sam's work. By which I mean 'use lasso logistic regression to develop and test a mode', but here with the additional data added in. The assumption/hypothesis is that this still won't have that good predictive power.
